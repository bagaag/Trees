...
namespace Trees.Models.Events
{
    ...
    public class KillEvent : Event
    {
        ...
        /// <summary>
        /// Runs the event filters on all plantings and returns list of matched plantings that have to die
        /// </summary>
        /// <returns></returns>
        public List<Planting> Execute(Table table)
        {
            ...
            // return list of filtered plantings
            return plantings;
        }
