...
namespace Trees.Core.Services
{
    ...
    public class GamePlay
    {
        ...
        public int StarterGroveCount { get; set; } = 3;
        public int MaxGroveCount { get; set; } = 3;
        public int TreeHandCount { get; set; } = 5;
        public int PlantingValue { get; set; } = 10;
        ...
        public void PlantTree(Table table, Grove grove)
        {
            ...
            if (grove.Land.Spaces > grove.Plantings.Count) {
                ...
                // add land if needed
                if (table.Groves.Find(g => g.HasSpace) == null && table.Groves.Count < MaxGroveCount) 
                {
